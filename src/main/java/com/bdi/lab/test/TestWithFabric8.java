...
//        System.out.println(queryPodPhase());
//        System.out.println(_kube.pods().inNamespace("k8s-test").withLabel("app","myweb").list().toString());
//        List<Pod> pods= _kube.pods().inNamespace("k8s-test").withLabel("","").list().getItems();
        System.out.println(_kube.services().inNamespace("k8s-test").withName("myweb").get().getStatus());
    }
